...
var store_protos_bread_pb = require("../../store/protos/bread_pb.js");

function serialize_BreadList(arg) {
  if (!(arg instanceof store_protos_bread_pb.BreadList)) {
...
function deserialize_BreadList(buffer_arg) {
  return store_protos_bread_pb.BreadList.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

function serialize_BuyBreadRequest(arg) {
  if (!(arg instanceof store_protos_bread_pb.BuyBreadRequest)) {
...
function deserialize_BuyBreadRequest(buffer_arg) {
  return store_protos_bread_pb.BuyBreadRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

function serialize_BuyBreadResponse(arg) {
  if (!(arg instanceof store_protos_bread_pb.BuyBreadResponse)) {
...
function deserialize_BuyBreadResponse(buffer_arg) {
  return store_protos_bread_pb.BuyBreadResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

function serialize_Empty(arg) {
  if (!(arg instanceof store_protos_bread_pb.Empty)) {
...
function deserialize_Empty(buffer_arg) {
  return store_protos_bread_pb.Empty.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

function serialize_StockBreadRequest(arg) {
  if (!(arg instanceof store_protos_bread_pb.StockBreadRequest)) {
...
function deserialize_StockBreadRequest(buffer_arg) {
  return store_protos_bread_pb.StockBreadRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

function serialize_StockBreadResponse(arg) {
  if (!(arg instanceof store_protos_bread_pb.StockBreadResponse)) {
...
function deserialize_StockBreadResponse(buffer_arg) {
  return store_protos_bread_pb.StockBreadResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

var BreadServiceService = (exports.BreadServiceService = {
  getAllBreads: {
    path: "/BreadService/GetAllBreads",
    requestStream: false,
    responseStream: false,
    requestType: store_protos_bread_pb.Empty,
    responseType: store_protos_bread_pb.BreadList,
  ...
  buyBread: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: store_protos_bread_pb.BuyBreadRequest,
    responseType: store_protos_bread_pb.BuyBreadResponse,
  ...
  stockBread: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: store_protos_bread_pb.StockBreadRequest,
    responseType: store_protos_bread_pb.StockBreadResponse,
...
exports.BreadServiceClient =
  grpc.makeGenericClientConstructor(BreadServiceService);
